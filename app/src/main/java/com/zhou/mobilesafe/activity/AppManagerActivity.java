...
public class AppManagerActivity extends Activity implements View.OnClickListener{
    ...
    //当应用被卸载了以后 让这个listview界面重新获取焦点 刷新界面 让那个被卸载的应用删除掉
    @Override
    ...
    //获取磁盘和sd卡的可用空间 显示到对应的textview上
    private void initTitle() {
        tv_memory = findViewById(R.id.tv_memory);
        tv_sb_memory = findViewById(R.id.tv_sb_memory);
        ...
        tv_sb_memory.setText("sd卡可用：" + sdMemoryAvailSpace);
    }
    ...
    private void initList() {
        ...
        tv_des = (TextView) findViewById(R.id.tv_appmanager_des);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.tv_share:
                ...
                intent.putExtra(Intent.EXTRA_TEXT,"只为梦中的明天");
                startActivity(intent);
                break;
        }
        //点击了窗体后 窗体消失
