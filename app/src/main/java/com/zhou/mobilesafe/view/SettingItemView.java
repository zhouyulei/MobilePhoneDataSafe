...
public class SettingItemView extends RelativeLayout {
    ...
    private String  NAMESPACE = "http://schemas.android.com/apk/res/com.zhou.mobilesafe";
    ...
    public SettingItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TextView tv_settingtitle = this.findViewById(R.id.tv_settingtitle);
        tv_des = this.findViewById(R.id.tv_des);
        cb_box = this.findViewById(R.id.cb_box);

        //获取自定义以及原生属性的操作写在此处，AttributeSet attrs中获取
        initAttrs(attrs);

        tv_settingtitle.setText(mDestitle);
    }
    ...
    /**
     * 判断是否开启更新的方法
     * @return 返回当前SettingItemView是否选中状态 true开启（checkBox返回true） false关闭（checkBox关闭）
     */
